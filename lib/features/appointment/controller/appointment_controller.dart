...
//   String selectedType = "Initial Visit";
//
//   // دالة selectType لتتوافق مع الـ onChanged في الواجهة (تستقبل String)
//   void selectType(String type) {
//     selectedType = type;
//     update();
//   }
...
//
//   // جعل المتغير غير قابل للقيم الفارغة لمنع أخطاء النوع والـ null-safety
//   String selectedSlot = "";
//
//   var doctorWorkDays = <String>[].obs;
//   var doctorScheduleMap = <String, List<String>>{}.obs;
...
//       DateTime start = DateFormat("HH:mm:ss").parse(_getStartTime());
//       int duration = (selectedType == "Initial Visit") ? 30 : 20;
//       return DateFormat("HH:mm:ss").format(start.add(Duration(minutes: duration)));
//     } catch (e) {
//       return "10:30:00";
//     }
//   }
...
//       }
//     } on DioException catch (e) {
//       _handleDioError(e, doctorId, clinicId);
//     } finally {
//       isLoading.value = false;
//     }
//   }
//
//   void _handleDioError(DioException e, int doctorId, int clinicId) {
//     String errorMessage = e.response?.data['message']?.toString() ?? "";
//
//     if (errorMessage.contains("Patient profile not found") || e.response?.statusCode == 404) {
//       _showIncompleteProfileWarning();
//       return;
//     }
//
//     if (e.response?.statusCode == 400 && (errorMessage.contains("full") || errorMessage.contains("overlaps"))) {
//       Get.defaultDialog(
//         title: AppMessages.dayFullyBookedTitle,
//         middleText: AppMessages.dayFullyBookedBody,
//         onConfirm: () => _joinWaitlist(doctorId, clinicId),
//       );
//     } else {
//       AppAlerts.showError(title: AppMessages.errorTitle, message: errorMessage);
//     }
//   }
//
//   Future<void> _joinWaitlist(int doctorId, int clinicId) async {
//     Get.back();
//     try {
...
//         requestedDate: DateFormat("yyyy-MM-dd").format(selectedDate),
//       );
//       if (success) AppAlerts.showSuccess(title: AppMessages.waitlistSuccessTitle, message: AppMessages.waitlistSuccessBody);
//     } catch (e) {
//       AppAlerts.showError(title: AppMessages.waitlistErrorTitle, message: e.toString());
//     }
//   }
//
//   void _showIncompleteProfileWarning() {
//     Get.defaultDialog(
//       title: AppMessages.incompleteProfileTitle,
//       middleText: AppMessages.incompleteProfileBody,
//       textConfirm: AppMessages.completeProfile,
//       onConfirm: () {
//         Get.back();
//         Get.toNamed(AppRoutes.medicalProfile);
...
//
//   Future<void> playSuccessEffect() async {
//     AppAlerts.showSuccess(title: AppMessages.successTitle, message: AppMessages.appointmentSuccess);
//     await _audioPlayer.play(AssetSource("sounds/notification_sound.mp3"));
//   }
// }